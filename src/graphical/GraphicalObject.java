...
public abstract class GraphicalObject {
	...
	public final void init(GraphicalScore gScore, GraphicalStaff gStaff, int x, int y) {
		this.gScore = gScore;
		this.gStaff = gStaff;
		this.x = x;
		this.y = y;
	...
	public final void init(GraphicalScore gScore, GraphicalStaff gStaff) {
		this.gScore = gScore;
		this.gStaff = gStaff;
	}
	...
	protected void setBounds(Graphics g, String glyph) {
		Graphics2D g2 = (Graphics2D) g;
		Font f = g.getFont();
		FontRenderContext frc = g2.getFontRenderContext();
		GlyphVector gv = f.createGlyphVector(frc, glyph);
		bounds = gv.getPixelBounds(frc, getX(), getY());
	}
